...
public class Result implements Parcelable
{
     ...
     * @param fio
     */
    public Result(Integer id, String token, String phone, String status, String avatar, String fio, Integer weight, Integer age, Integer height, List<String> goals, String createdAt, String updatedAt) {
        super();
        this.id = id;
        this.token = token;
        this.phone = phone;
